...
export function EditProductModal({ isOpen, onClose, product, onSave }: EditProductModalProps) {
    ...
    const getInitialFormData = () => ({
        ...
        restrictedTopics: product?.restrictedTopics?.join(', ') || '',
        preferredHashtags: product?.preferredHashtags?.join(', ') || '',
    });

    const [formData, setFormData] = useState(getInitialFormData());
    const [brandColors, setBrandColors] = useState<BrandColor[]>(product?.brandColors || []);
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="modal-action">
                        ...
                        <button type="submit" className="btn btn-primary">
                            <i className="fa-solid fa-duotone fa-floppy-disk mr-2"></i>
                            Save Changes
                        </button>
                    </div>
                </form>
